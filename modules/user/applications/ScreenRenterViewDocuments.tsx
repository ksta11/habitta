...
import { getApplicationDocuments } from '../../../libs/application/documents-service';
import {
    standarScreenBackground
} from '../../../utils/TokensDesing';

export default function RenterViewDocuments() {
          ...
          <View className="flex-row items-start">
            ...
            <View className="flex-1 ml-3">
              ...
              <Text className="text-xs text-blue-800 leading-5">
                Puedes ver los documentos subidos, pero no puedes subir nuevos en este momento. La subida estará disponible cuando el propietario solicite documentos adicionales.
              </Text>
            </View>
          </View>
        </View>
          ...
          {loading ? (
            ...
            <View className="py-10 items-center">
              ...
              <Text className="text-gray-400 mt-2 text-center text-sm">
                Los documentos aparecerán aquí cuando el propietario los solicite y tú los subas
              </Text>
            </View>
          ) : (
            documents.map((doc) => (
