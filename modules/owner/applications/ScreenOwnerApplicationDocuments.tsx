...
export default function OwnerApplicationDocuments() {
  ...
  return (
    <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      <View className={`flex-1 ${standarScreenBackground}`}>
        ...
        >
          {/* Formulario de subida - Siempre habilitado para owner */}
                ...
                render={({ field: { onChange, value } }) => (
                  <PickerAtom
                    ...
                    options={[
                      ...
                      { label: 'Documento de propiedad', value: 'propiedad' },
                      { label: 'Certificado de libertad', value: 'libertad' },
                      { label: 'Recibo de servicios', value: 'servicios' },
                      { label: 'Fotos adicionales', value: 'fotos' },
