      ...
      <View className="flex-1 bg-black/60 justify-end">
        ...
        <View className="bg-white rounded-t-[32px] h-[90%] shadow-2xl">
          ...
          >
            ...
            <View className="bg-gray-50 rounded-3xl p-5 mb-6">
              ...
              <View className="space-y-3">
                ...
                <View className="flex-row items-center">
                  ...
                  <Text className="text-sm text-gray-600 ml-2 mr-2">Email:</Text>
                  <Text className="text-sm font-semibold text-gray-900 flex-1">
                ...
                <View>
                  ...
                  <View className="flex-row gap-2 mt-2">
                    <WhatsAppButton
                      ...
                      message={`Hola ${application.renter.name}, te contacto sobre el contrato de arrendamiento de la propiedad "${application.property.title}".`}
                      variant="secondary"
                    />
                    <PhoneCallButton
                      phoneNumber={application.renter.phone}
                ...
                {typeof application.renter.ratingAverage === 'number' && (
                  <View className="flex-row items-center">
                    ...
                    <Text className="text-sm text-gray-600 ml-2 mr-2">Calificación:</Text>
                    <Text className="text-sm font-semibold text-gray-900 flex-1">
                      {Math.round(application.renter.ratingAverage)}%
                    </Text>
                  </View>
                )}
              </View>
            ...
            <View className="bg-blue-50 rounded-3xl p-5 mb-6">
              ...
              <View className="space-y-3">
                ...
                <View className="flex-row items-center">
                  ...
                  <Text className="text-sm text-gray-600 ml-2 mr-2">Estado:</Text>
                  <Text className="text-sm font-semibold text-green-600 flex-1">
                    Aprobada - Lista para firmar
                  </Text>
                </View>
              </View>
            </View>
            ...
            <View className="bg-purple-50 border border-purple-200 rounded-3xl p-5 mb-6">
              <View className="flex-row items-center mb-4">
                <View className="bg-purple-500/10 p-2.5 rounded-full">
              ...
              <View className="space-y-3">
                <View className="flex-row justify-between">
                  <Text className="text-sm text-gray-600">Propiedad:</Text>
                ...
                <View className="flex-row justify-between">
                  <Text className="text-sm text-gray-600">Arrendatario:</Text>
                  <Text className="text-sm font-semibold text-gray-900 flex-1 text-right">
                    {application.renter.name}
                  </Text>
                </View>
                ...
                <View className="flex-row justify-between">
                  <Text className="text-sm text-gray-600">Renta mensual:</Text>
                  <Text className="text-sm font-bold text-lavender-indigo flex-1 text-right">
                    ${application.property.price.toLocaleString()}
                  </Text>
                </View>

                <View className="border-t border-purple-200 pt-3 mt-2">
                  <Text className="text-xs text-gray-500 leading-5">
                    Al firmar este contrato, ambas partes se comprometen a cumplir con los términos y condiciones establecidos en el contrato de arrendamiento.
                  </Text>
                </View>
              </View>
            </View>
              ...
              <View className="flex-row items-start">
                ...
                <View className="flex-1 ml-3">
                  ...
                  <Text className="text-xs text-amber-800 leading-5">
                    Al firmar este contrato, confirmas que has revisado toda la información y aceptas 
                    los términos del arrendamiento. Esta acción formalizará el contrato con el arrendatario 
                    y comenzará el proceso de arrendamiento.
                  </Text>
                </View>
              </View>
            </View>
